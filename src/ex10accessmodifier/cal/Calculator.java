...
public class Calculator {
	...
	/*
	생성자 메서드 : 해당 클래스의 객체가 생성될 때 덧셈, 뺄셈을 위한
		객체도 동시에 생성된다.
	 */
	public Calculator() {
		adder = new Adder();
	...
	/*
	멤버 메서드 : 덧셈 혹은 뺄셈 연산 후 결과를 반환하는 메서드로
	각 연산을 위한 해당 default클래스의 멤버 메서드를 호출한 후
	결과를 반환 받는다.
	 */
	...
	/*
	연산의 횟수를 디스플레이 해주는 메서드로 정보은닉 처리된
	멤버 변수의 출력을 위해 각 메서드를 호출한다.
	 */
