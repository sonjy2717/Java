...
public class E05For {
	...
	public static void main(String[] args) {
		...
		total = 0;
		for (int i = 0; i <= 10; i+=2) { // 복합대입 연산자 사용가능
			total += i;
		}
...
//		}
		...
		for (int j = 0; j<=5; j++) ;
		{
			System.out.println("이렇게 작성하면 안됨");
		}
		...
		/*
		for문의 초기 값을 외부(넓은 지역)에서 선언하면 해당 변수는 for문의
