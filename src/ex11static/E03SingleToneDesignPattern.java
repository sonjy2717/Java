...
class SingleTone {
	...
	/*
	JVM(자바가상머신)에 의해 프로그램이 시작될 때 정적 변수는 미리
	...
	없으므로 new키워드를 통해 객체를 생성할 수 없게된다.
	 */
	private SingleTone() {} // 기본생성자
	
	/*
	정적 메서드로 선언된 getInstance() 메서드에서 해당 객체를
	외부로 반환한다.
	 */
...
public class E03SingleToneDesignPattern {
	...
	public static void main(String[] args) {
		...
		/*
		일반적인 방식의 객체 생성이므로 객체를 생성할 때마다 새로운
		참조 값(주소 값)을 할당받는 인스턴스가 된다.
		 */
