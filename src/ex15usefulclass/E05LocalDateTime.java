...
public class E05LocalDateTime {
	...
	public static void main(String[] args) {
		...
		System.out.println("현재 년 : " + localDate.getYear());
		System.out.println("현재 월 : " + localDate.getMonth());
		System.out.println("현재 일 : " + localDate.getDayOfMonth());
		System.out.println("현재 요일 : " + localDate.getDayOfWeek());
