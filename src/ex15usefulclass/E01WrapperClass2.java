...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("10 + strNumber = " + (10 + strNumber)); // 문자열
		...
		/*
		isLetter() : 문자인지 아닌지 여부를 판단하는 메서드로 특수기호나
			숫자형일때는 false를 반환한다.
		 */
		...
		/*
		시나리오] 주어진 문자열안에 몇 개의 공백문자(스페이스)가 있는지
		판단하는 프로그램을 작성하시오.
